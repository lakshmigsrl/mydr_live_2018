...
class SitemapComponent extends Component
{
    ...
    public function addLocation($loc, $priority = 0.5, $lastmod = null, $changefreq = null, $title = null)
    {
        ...
        array_push($this->locations, compact('loc', 'lastmod', 'changefreq', 'priority', 'title'));
