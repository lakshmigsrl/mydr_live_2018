   ...
   $dbPassword = $dbVars['default']['password'];
	...
	if($cakedb->connect_errno){
		...
		?>
                <html>
                <head>
                        <title>Medobs Utility Scripts</title>
			...
			<script type="text/javascript">
                                ...
                                function loadEventSource(){
                                        ...
                                        if (!!window.EventSource) {
                                                var source = new EventSource("get_mydr_cmis_attributes_progress_active.php");
		...
		<body>
			<h1>myDr CMIs list with Attributes</h1>
			<form action='get_mydr_cmis_attributes.php' method='post'>
