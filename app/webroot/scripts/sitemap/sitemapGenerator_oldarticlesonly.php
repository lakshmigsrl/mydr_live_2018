...
echo '<link href="/scripts/style.css" rel="stylesheet" type="text/css" />';
	...
	echo "<h1>myDr's Sitemap Generator - old /articles only...</h1>";
	echo "<form action='sitemapGenerator_oldarticlesonly.php' method='post'>";
   ...
   $startTags_SiteMap = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>".
	...
	$fname = 'sitemap_mydr__oldarticles.xml';
