...
$config['authentication'] = function () {
    ...
    $ckfinderAuth = base64_decode($_COOKIE['ckfallmeow']);
    if ($ckfinderAuth=='authorized') {
      return true;
    }
    else {
      return false;
...
//$config['licenseName'] = '';
//$config['licenseKey']  = '';
if($_SERVER["SERVER_NAME"] == 'qa-staging-site.mydr.com.au'){
$config['LicenseName'] = 'qa-staging-site.mydr.com.au';
$config['LicenseKey']  = 'X979-EYTJ-DTBT-KER5-E8GG-2A2J-SCRG';
define("S3BUKET", "mydr-staging");
define("S3KEY", "AKIAIDTCLJBOPWFI6P6Q");
define("S3SECRET", "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");
define("S3URL", "http://mydr-staging.s3-website-ap-southeast-2.amazonaws.com/");
}else{
$config['LicenseName'] = 'mydr.com.au';
$config['LicenseKey']  = 'NE7E-D94N-F3LB-KGU4-V7E1-4467-1V6A';
define("S3BUKET", "mydr-drme");
define("S3KEY", "AKIAIDTCLJBOPWFI6P6Q");
define("S3SECRET", "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");
define("S3URL", "https://d2m3czf6fvb8bh.cloudfront.net/site_content");
}
